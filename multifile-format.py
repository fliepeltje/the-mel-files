...
LAYOUT_FILE = "in-files/MM20220629_summary_ROS_DC3000_ef_library.xlsx"
PLATES_DIR = "in-files" # enter "." if it is in the same directory as the script
OUTPUT_PREFIX = "DD_out"
